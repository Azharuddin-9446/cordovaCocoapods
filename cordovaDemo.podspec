#
#  Be sure to run `pod spec lint cordovaDemo.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "cordovaDemo"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of cordovaDemo."
  ...
  spec.author             = { "azharuddin" => "93505171+azhar0904@users.noreply.github.com" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
  ...
  spec.source       = { :git => "https://github.com/Azharuddin-9446/cordovaCocoapods.git", :tag => "#{spec.version}" }
